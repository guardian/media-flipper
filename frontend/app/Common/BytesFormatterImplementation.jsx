class BytesFormatterImplementation {
    ...
    static getString(startingValue){
        const valueAndSuffix = BytesFormatterImplementation.getValueAndSuffix(startingValue);
        return valueAndSuffix[0].toString() + valueAndSuffix[1];
    }
}
